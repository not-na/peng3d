# -*- coding: utf-8 -*-
#
# Peng3d documentation build configuration file, created by
...
html_use_opensearch = 'https://peng3d.readthedocs.org/en/latest/'
...
latex_documents = [
  (master_doc, 'Peng3d.tex', u'Peng3d Documentation',
   u'notna', 'manual'),
]
...
man_pages = [
    (master_doc, 'peng3d', u'Peng3d Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Peng3d', u'Peng3d Documentation',
   author, 'Peng3d', 'One line description of project.',
   'Miscellaneous'),
]
