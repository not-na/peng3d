...
class Container(Widget):
    ...
    def __init__(
        ...
        self.stencil_vlist = pyglet.graphics.vertex_list(
            4,
            "v2f",
            ("c4B", [0, 0, 0, 0] * 4),
        )
    ...
    def setBackground(self, bg):
        ...
        if isinstance(bg, list) or isinstance(bg, tuple):
            ...
            self.bg = ContainerButtonBackground(
                self, borderstyle=bg, batch=self.batch2d
            )
            self.redraw()
...
class ScrollableContainer(Container):
    ...
    def __init__(
        ...
        super(ScrollableContainer, self).__init__(
            name,
            submenu,
            window,
            peng,
    ...
    def on_redraw(self):
        ...
        super(
            ScrollableContainer, self
        ).on_redraw()  # Re-draws everything, including child widgets
